...
2. Commit and push to `main` (commit convention: `[vX.X.X] description`)
3. GitHub Actions (`.github/workflows/deploy.yml`) redeploys to GitHub Pages automatically within ~1–2 minutes
